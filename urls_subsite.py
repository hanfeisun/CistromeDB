...
#
#    url('^gsm_parser_demo/$', views.gsm_parser_demo,
#        name="gsm_parser_demo"),
#
#
...
#        name="generic_delete"),
#    url(r'^generic_merge/(\w+)/$', views.generic_merge,
#        name="generic_merge"),
...
#    url(r'^ncbiAdapter/', include('ncbiAdapter.urls')),
...
#        name="change_samples_status"),
    ...
    url(r'^new_admin/', include("massadmin.urls")),
