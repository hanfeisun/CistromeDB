...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('datacollection_datasets', 'cor_pdf_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Datasets.cor_r_file'
        db.add_column('datacollection_datasets', 'cor_r_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Datasets.ceas_xls_file'
        db.add_column('datacollection_datasets', 'ceas_xls_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Datasets.cor_pdf_file'
        db.delete_column('datacollection_datasets', 'cor_pdf_file')

        # Deleting field 'Datasets.cor_r_file'
        db.delete_column('datacollection_datasets', 'cor_r_file')

        # Deleting field 'Datasets.ceas_xls_file'
        db.delete_column('datacollection_datasets', 'ceas_xls_file')
