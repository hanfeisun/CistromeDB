...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conditions.aliases'
        db.add_column(u'datacollection_conditions', 'aliases',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Antibodies.aliases'
        db.add_column(u'datacollection_antibodies', 'aliases',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conditions.aliases'
        db.delete_column(u'datacollection_conditions', 'aliases')

        # Deleting field 'Antibodies.aliases'
        db.delete_column(u'datacollection_antibodies', 'aliases')
