...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Datasets.factor'
        db.add_column(u'datacollection_datasets', 'factor',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['datacollection.Factors'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.species'
        db.add_column(u'datacollection_datasets', 'species',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['datacollection.Species'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.cell_type'
        db.add_column(u'datacollection_datasets', 'cell_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['datacollection.CellTypes'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.cell_line'
        db.add_column(u'datacollection_datasets', 'cell_line',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['datacollection.CellLines'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.cell_pop'
        db.add_column(u'datacollection_datasets', 'cell_pop',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['datacollection.CellPops'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.strain'
        db.add_column(u'datacollection_datasets', 'strain',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['datacollection.Strains'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.disease_state'
        db.add_column(u'datacollection_datasets', 'disease_state',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['datacollection.DiseaseStates'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.tissue_type'
        db.add_column(u'datacollection_datasets', 'tissue_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['datacollection.TissueTypes'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Datasets.factor'
        db.delete_column(u'datacollection_datasets', 'factor_id')

        # Deleting field 'Datasets.species'
        db.delete_column(u'datacollection_datasets', 'species_id')

        # Deleting field 'Datasets.cell_type'
        db.delete_column(u'datacollection_datasets', 'cell_type_id')

        # Deleting field 'Datasets.cell_line'
        db.delete_column(u'datacollection_datasets', 'cell_line_id')

        # Deleting field 'Datasets.cell_pop'
        db.delete_column(u'datacollection_datasets', 'cell_pop_id')

        # Deleting field 'Datasets.strain'
        db.delete_column(u'datacollection_datasets', 'strain_id')

        # Deleting field 'Datasets.disease_state'
        db.delete_column(u'datacollection_datasets', 'disease_state_id')

        # Deleting field 'Datasets.tissue_type'
        db.delete_column(u'datacollection_datasets', 'tissue_type_id')
