...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Samples.upload_date'
        db.delete_column(u'datacollection_samples', 'upload_date')

        # Deleting field 'Samples.update_date'
        db.delete_column(u'datacollection_samples', 'update_date')

        # Deleting field 'Samples.date_collected'
        db.delete_column(u'datacollection_samples', 'date_collected')

        # Adding field 'Samples.dc_collect_date'
        db.add_column(u'datacollection_samples', 'dc_collect_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Samples.dc_upload_date'
        db.add_column(u'datacollection_samples', 'dc_upload_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Samples.geo_last_update_date'
        db.add_column(u'datacollection_samples', 'geo_last_update_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Samples.geo_submission_date'
        db.add_column(u'datacollection_samples', 'geo_submission_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Samples.upload_date'
        db.add_column(u'datacollection_samples', 'upload_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Samples.date_collected'
        db.add_column(u'datacollection_samples', 'date_collected',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Samples.dc_collect_date'
        db.delete_column(u'datacollection_samples', 'dc_collect_date')

        # Deleting field 'Samples.dc_upload_date'
        db.delete_column(u'datacollection_samples', 'dc_upload_date')

        # Deleting field 'Samples.geo_last_update_date'
        db.delete_column(u'datacollection_samples', 'geo_last_update_date')

        # Deleting field 'Samples.geo_submission_date'
        db.delete_column(u'datacollection_samples', 'geo_submission_date')
    ...
    models = {
        ...
        u'datacollection.samples': {
            ...
            'geo_submission_date': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
