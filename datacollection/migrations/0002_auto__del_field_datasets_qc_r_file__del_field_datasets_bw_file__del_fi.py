...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'datasets.qc_r_file'
        db.delete_column('datacollection_datasets', 'qc_r_file')

        # Deleting field 'datasets.bw_file'
        db.delete_column('datacollection_datasets', 'bw_file')

        # Deleting field 'datasets.qc_file'
        db.delete_column('datacollection_datasets', 'qc_file')

        # Deleting field 'datasets.treatment_file'
        db.delete_column('datacollection_datasets', 'treatment_file')

        # Deleting field 'datasets.wig_file'
        db.delete_column('datacollection_datasets', 'wig_file')

        # Deleting field 'datasets.control_bed_graph_file'
        db.delete_column('datacollection_datasets', 'control_bed_graph_file')

        # Deleting field 'datasets.bed_graph_file'
        db.delete_column('datacollection_datasets', 'bed_graph_file')

        # Adding field 'Datasets.treat_bw_file'
        db.add_column('datacollection_datasets', 'treat_bw_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Datasets.rep_treat_bw'
        db.add_column('datacollection_datasets', 'rep_treat_bw', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, null=True, blank=True), keep_default=False)

        # Adding field 'Datasets.rep_cont_bw'
        db.add_column('datacollection_datasets', 'rep_cont_bw', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, null=True, blank=True), keep_default=False)

        # Adding field 'Datasets.rep_treat_peaks'
        db.add_column('datacollection_datasets', 'rep_treat_peaks', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, null=True, blank=True), keep_default=False)

        # Adding field 'Datasets.rep_treat_summits'
        db.add_column('datacollection_datasets', 'rep_treat_summits', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, null=True, blank=True), keep_default=False)

        # Adding field 'Datasets.cont_bw_file'
        db.add_column('datacollection_datasets', 'cont_bw_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'datasets.qc_r_file'
        db.add_column('datacollection_datasets', 'qc_r_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'datasets.bw_file'
        db.add_column('datacollection_datasets', 'bw_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'datasets.qc_file'
        db.add_column('datacollection_datasets', 'qc_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'datasets.treatment_file'
        db.add_column('datacollection_datasets', 'treatment_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'datasets.wig_file'
        db.add_column('datacollection_datasets', 'wig_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'datasets.control_bed_graph_file'
        db.add_column('datacollection_datasets', 'control_bed_graph_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'datasets.bed_graph_file'
        db.add_column('datacollection_datasets', 'bed_graph_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'Datasets.treat_bw_file'
        db.delete_column('datacollection_datasets', 'treat_bw_file')

        # Deleting field 'Datasets.rep_treat_bw'
        db.delete_column('datacollection_datasets', 'rep_treat_bw')

        # Deleting field 'Datasets.rep_cont_bw'
        db.delete_column('datacollection_datasets', 'rep_cont_bw')

        # Deleting field 'Datasets.rep_treat_peaks'
        db.delete_column('datacollection_datasets', 'rep_treat_peaks')

        # Deleting field 'Datasets.rep_treat_summits'
        db.delete_column('datacollection_datasets', 'rep_treat_summits')

        # Deleting field 'Datasets.cont_bw_file'
        db.delete_column('datacollection_datasets', 'cont_bw_file')
