...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Qc.qc3'
        db.alter_column('datacollection_qc', 'qc3', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Qc.qc2'
        db.alter_column('datacollection_qc', 'qc2', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Qc.qc1'
        db.alter_column('datacollection_qc', 'qc1', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Qc.qc7'
        db.alter_column('datacollection_qc', 'qc7', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Qc.qc6'
        db.alter_column('datacollection_qc', 'qc6', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Qc.qc5'
        db.alter_column('datacollection_qc', 'qc5', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Qc.qc4'
        db.alter_column('datacollection_qc', 'qc4', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Qc.qc9'
        db.alter_column('datacollection_qc', 'qc9', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Qc.qc8'
        db.alter_column('datacollection_qc', 'qc8', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Qc.qc10'
        db.alter_column('datacollection_qc', 'qc10', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Qc.qc3'
        db.alter_column('datacollection_qc', 'qc3', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Qc.qc2'
        db.alter_column('datacollection_qc', 'qc2', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Qc.qc1'
        db.alter_column('datacollection_qc', 'qc1', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Qc.qc7'
        db.alter_column('datacollection_qc', 'qc7', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Qc.qc6'
        db.alter_column('datacollection_qc', 'qc6', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Qc.qc5'
        db.alter_column('datacollection_qc', 'qc5', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Qc.qc4'
        db.alter_column('datacollection_qc', 'qc4', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Qc.qc9'
        db.alter_column('datacollection_qc', 'qc9', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Qc.qc8'
        db.alter_column('datacollection_qc', 'qc8', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Qc.qc10'
        db.alter_column('datacollection_qc', 'qc10', self.gf('django.db.models.fields.CharField')(max_length=255))
