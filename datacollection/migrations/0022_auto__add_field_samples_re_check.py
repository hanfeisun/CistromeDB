...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Samples.re_check'
        db.add_column(u'datacollection_samples', 're_check',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Samples.re_check'
        db.delete_column(u'datacollection_samples', 're_check')
