...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Qc.qc3'
        db.delete_column(u'datacollection_qc', 'qc3')

        # Deleting field 'Qc.qc2'
        db.delete_column(u'datacollection_qc', 'qc2')

        # Deleting field 'Qc.qc1'
        db.delete_column(u'datacollection_qc', 'qc1')

        # Deleting field 'Qc.qc7'
        db.delete_column(u'datacollection_qc', 'qc7')

        # Deleting field 'Qc.qc6'
        db.delete_column(u'datacollection_qc', 'qc6')

        # Deleting field 'Qc.qc5'
        db.delete_column(u'datacollection_qc', 'qc5')

        # Deleting field 'Qc.qc4'
        db.delete_column(u'datacollection_qc', 'qc4')

        # Deleting field 'Qc.qc8'
        db.delete_column(u'datacollection_qc', 'qc8')

        # Adding field 'Qc.fastqc'
        db.add_column(u'datacollection_qc', 'fastqc',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Qc.mapped'
        db.add_column(u'datacollection_qc', 'mapped',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)
        ...
        # Adding field 'Qc.pbc'
        db.add_column(u'datacollection_qc', 'pbc',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Qc.peaks'
        db.add_column(u'datacollection_qc', 'peaks',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Qc.frip'
        db.add_column(u'datacollection_qc', 'frip',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Qc.dhs'
        db.add_column(u'datacollection_qc', 'dhs',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Qc.motif'
        db.add_column(u'datacollection_qc', 'motif',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding field 'Qc.qc3'
        db.add_column(u'datacollection_qc', 'qc3',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Qc.qc2'
        db.add_column(u'datacollection_qc', 'qc2',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Qc.qc1'
        db.add_column(u'datacollection_qc', 'qc1',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Qc.qc7'
        db.add_column(u'datacollection_qc', 'qc7',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Qc.qc6'
        db.add_column(u'datacollection_qc', 'qc6',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Qc.qc5'
        db.add_column(u'datacollection_qc', 'qc5',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Qc.qc4'
        db.add_column(u'datacollection_qc', 'qc4',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Qc.qc8'
        db.add_column(u'datacollection_qc', 'qc8',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Deleting field 'Qc.fastqc'
        db.delete_column(u'datacollection_qc', 'fastqc')

        # Deleting field 'Qc.mapped'
        db.delete_column(u'datacollection_qc', 'mapped')

        # Deleting field 'Qc.map_ration'
        db.delete_column(u'datacollection_qc', 'map_ration')

        # Deleting field 'Qc.pbc'
        db.delete_column(u'datacollection_qc', 'pbc')

        # Deleting field 'Qc.peaks'
        db.delete_column(u'datacollection_qc', 'peaks')

        # Deleting field 'Qc.frip'
        db.delete_column(u'datacollection_qc', 'frip')

        # Deleting field 'Qc.dhs'
        db.delete_column(u'datacollection_qc', 'dhs')

        # Deleting field 'Qc.motif'
        db.delete_column(u'datacollection_qc', 'motif')
    ...
    models = {
        ...
        u'datacollection.qc': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'map_ration': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
