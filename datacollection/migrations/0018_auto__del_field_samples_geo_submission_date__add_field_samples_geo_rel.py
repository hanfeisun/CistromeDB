...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Samples.geo_release_date'
        db.add_column(u'datacollection_samples', 'geo_release_date',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Samples.geo_release_date'
        db.delete_column(u'datacollection_samples', 'geo_release_date')
