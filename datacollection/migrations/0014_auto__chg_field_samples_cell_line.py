...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Samples.cell_line'
        db.alter_column(u'datacollection_samples', 'cell_line_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.CellLines'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Samples.cell_line'
        db.alter_column(u'datacollection_samples', 'cell_line_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.CellLines'], null=True))
