...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DiseaseStates.name'
        db.alter_column('datacollection_diseasestates', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Assemblies.name'
        db.alter_column('datacollection_assemblies', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Strains.name'
        db.alter_column('datacollection_strains', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Antibodies.name'
        db.alter_column('datacollection_antibodies', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'CellTypes.name'
        db.alter_column('datacollection_celltypes', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'CellPops.name'
        db.alter_column('datacollection_cellpops', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'TissueTypes.name'
        db.alter_column('datacollection_tissuetypes', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'CellLines.name'
        db.alter_column('datacollection_celllines', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Species.name'
        db.alter_column('datacollection_species', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Factors.type'
        db.alter_column('datacollection_factors', 'type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Factors.name'
        db.alter_column('datacollection_factors', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Journals.issn'
        db.alter_column('datacollection_journals', 'issn', self.gf('django.db.models.fields.CharField')(max_length=9, null=True))

        # Changing field 'Journals.impact_factor'
        db.alter_column('datacollection_journals', 'impact_factor', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Journals.name'
        db.alter_column('datacollection_journals', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'DiseaseStates.name'
        db.alter_column('datacollection_diseasestates', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Assemblies.name'
        db.alter_column('datacollection_assemblies', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Strains.name'
        db.alter_column('datacollection_strains', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Antibodies.name'
        db.alter_column('datacollection_antibodies', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'CellTypes.name'
        db.alter_column('datacollection_celltypes', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'CellPops.name'
        db.alter_column('datacollection_cellpops', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'TissueTypes.name'
        db.alter_column('datacollection_tissuetypes', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'CellLines.name'
        db.alter_column('datacollection_celllines', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Species.name'
        db.alter_column('datacollection_species', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Factors.type'
        db.alter_column('datacollection_factors', 'type', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Factors.name'
        db.alter_column('datacollection_factors', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Journals.issn'
        db.alter_column('datacollection_journals', 'issn', self.gf('django.db.models.fields.CharField')(default='', max_length=9))

        # Changing field 'Journals.impact_factor'
        db.alter_column('datacollection_journals', 'impact_factor', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Journals.name'
        db.alter_column('datacollection_journals', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    ...
    models = {
        ...
        'datacollection.datasets': {
            ...
            'conts': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'CONTS'", 'default': 'None', 'to': "orm['datacollection.Samples']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            ...
            'treats': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'TREATS'", 'symmetrical': 'False', 'to': "orm['datacollection.Samples']"}),
