...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Samples.series_id'
        db.add_column(u'datacollection_samples', 'series_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Samples.series_id'
        db.delete_column(u'datacollection_samples', 'series_id')
