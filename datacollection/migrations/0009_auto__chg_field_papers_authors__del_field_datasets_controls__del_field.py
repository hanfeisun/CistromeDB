...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Papers.authors'
        db.alter_column('datacollection_papers', 'authors', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))
        # Deleting field 'Datasets.controls'
        db.delete_column('datacollection_datasets', 'controls')

        # Deleting field 'Datasets.treatments'
        db.delete_column('datacollection_datasets', 'treatments')

        # Adding field 'Samples.other_ids'
        db.add_column('datacollection_samples', 'other_ids',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Samples.fastq_file_url'
        db.alter_column('datacollection_samples', 'fastq_file_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Papers.authors'
        db.alter_column('datacollection_papers', 'authors', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Adding field 'Datasets.controls'
        db.add_column('datacollection_datasets', 'controls',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.treatments'
        db.add_column('datacollection_datasets', 'treatments',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Samples.other_ids'
        db.delete_column('datacollection_samples', 'other_ids')


        # Changing field 'Samples.fastq_file_url'
        db.alter_column('datacollection_samples', 'fastq_file_url', self.gf('django.db.models.fields.URLField')(max_length=255, null=True))
