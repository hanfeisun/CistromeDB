...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Datasets.qc_summary'
        db.add_column(u'datacollection_datasets', 'qc_summary',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Datasets.qc_summary'
        db.delete_column(u'datacollection_datasets', 'qc_summary')
