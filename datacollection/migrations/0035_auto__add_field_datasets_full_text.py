...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Datasets.full_text'
        db.add_column(u'datacollection_datasets', 'full_text',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Datasets.full_text'
        db.delete_column(u'datacollection_datasets', 'full_text')
