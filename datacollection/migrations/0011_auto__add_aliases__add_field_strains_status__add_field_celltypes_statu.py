...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'datacollection_aliases', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('factor', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['datacollection.Factors'], null=True, blank=True)),
        ))
        db.send_create_signal(u'datacollection', ['Aliases'])

        # Adding field 'Strains.status'
        db.add_column(u'datacollection_strains', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CellTypes.status'
        db.add_column(u'datacollection_celltypes', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CellPops.status'
        db.add_column(u'datacollection_cellpops', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TissueTypes.status'
        db.add_column(u'datacollection_tissuetypes', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CellLines.status'
        db.add_column(u'datacollection_celllines', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Factors.status'
        db.add_column(u'datacollection_factors', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'datacollection_aliases')

        # Deleting field 'Strains.status'
        db.delete_column(u'datacollection_strains', 'status')

        # Deleting field 'CellTypes.status'
        db.delete_column(u'datacollection_celltypes', 'status')

        # Deleting field 'CellPops.status'
        db.delete_column(u'datacollection_cellpops', 'status')

        # Deleting field 'TissueTypes.status'
        db.delete_column(u'datacollection_tissuetypes', 'status')

        # Deleting field 'CellLines.status'
        db.delete_column(u'datacollection_celllines', 'status')

        # Deleting field 'Factors.status'
        db.delete_column(u'datacollection_factors', 'status')
    ...
    models = {
        ...
        u'datacollection.aliases': {
            ...
            'factor': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['datacollection.Factors']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'datacollection.samples': {
            ...
            'antibody': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'antibody'", 'null': 'True', 'blank': 'True', 'to': u"orm['datacollection.Antibodies']"}),
            'assembly': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['datacollection.Assemblies']", 'null': 'True', 'blank': 'True'}),
            ...
            'cell_pop': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['datacollection.CellPops']", 'null': 'True', 'blank': 'True'}),
            'cell_type': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['datacollection.CellTypes']", 'null': 'True', 'blank': 'True'}),
            'comments': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'condition': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['datacollection.Conditions']", 'null': 'True', 'blank': 'True'}),
            'curator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'curator'", 'null': 'True', 'blank': 'True', 'to': u"orm['auth.User']"}),
            'date_collected': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'disease_state': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['datacollection.DiseaseStates']", 'null': 'True', 'blank': 'True'}),
            'factor': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['datacollection.Factors']", 'null': 'True', 'blank': 'True'}),
            ...
            'paper': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['datacollection.Papers']", 'null': 'True', 'blank': 'True'}),
            'platform': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['datacollection.Platforms']", 'null': 'True', 'blank': 'True'}),
            'species': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['datacollection.Species']", 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'new'", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'strain': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['datacollection.Strains']", 'null': 'True', 'blank': 'True'}),
            'tissue_type': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['datacollection.TissueTypes']", 'null': 'True', 'blank': 'True'}),
            'unique_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
