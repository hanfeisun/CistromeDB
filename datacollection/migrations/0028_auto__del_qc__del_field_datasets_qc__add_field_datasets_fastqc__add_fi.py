...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Qc'
        db.delete_table(u'datacollection_qc')

        # Deleting field 'Datasets.qc'
        db.delete_column(u'datacollection_datasets', 'qc_id')

        # Adding field 'Datasets.fastqc'
        db.add_column(u'datacollection_datasets', 'fastqc',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Datasets.mapped'
        db.add_column(u'datacollection_datasets', 'mapped',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Datasets.map_ratio'
        db.add_column(u'datacollection_datasets', 'map_ratio',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Datasets.pbc'
        db.add_column(u'datacollection_datasets', 'pbc',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Datasets.peaks'
        db.add_column(u'datacollection_datasets', 'peaks',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Datasets.frip'
        db.add_column(u'datacollection_datasets', 'frip',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Datasets.dhs'
        db.add_column(u'datacollection_datasets', 'dhs',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Datasets.motif'
        db.add_column(u'datacollection_datasets', 'motif',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding model 'Qc'
        db.create_table(u'datacollection_qc', (
            ('motif', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('peaks', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('fastqc', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('frip', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('qc10', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('map_ratio', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('qc9', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('pbc', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('mapped', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('dhs', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
        ))
        db.send_create_signal(u'datacollection', ['Qc'])

        # Adding field 'Datasets.qc'
        db.add_column(u'datacollection_datasets', 'qc',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['datacollection.Qc'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Datasets.fastqc'
        db.delete_column(u'datacollection_datasets', 'fastqc')

        # Deleting field 'Datasets.mapped'
        db.delete_column(u'datacollection_datasets', 'mapped')

        # Deleting field 'Datasets.map_ratio'
        db.delete_column(u'datacollection_datasets', 'map_ratio')

        # Deleting field 'Datasets.pbc'
        db.delete_column(u'datacollection_datasets', 'pbc')

        # Deleting field 'Datasets.peaks'
        db.delete_column(u'datacollection_datasets', 'peaks')

        # Deleting field 'Datasets.frip'
        db.delete_column(u'datacollection_datasets', 'frip')

        # Deleting field 'Datasets.dhs'
        db.delete_column(u'datacollection_datasets', 'dhs')

        # Deleting field 'Datasets.motif'
        db.delete_column(u'datacollection_datasets', 'motif')
