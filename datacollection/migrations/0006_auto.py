...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field treats on 'Datasets'
        db.create_table('datacollection_datasets_treats', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('datasets', models.ForeignKey(orm['datacollection.datasets'], null=False)),
            ('samples', models.ForeignKey(orm['datacollection.samples'], null=False))
        ))
        db.create_unique('datacollection_datasets_treats', ['datasets_id', 'samples_id'])

        # Adding M2M table for field conts on 'Datasets'
        db.create_table('datacollection_datasets_conts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('datasets', models.ForeignKey(orm['datacollection.datasets'], null=False)),
            ('samples', models.ForeignKey(orm['datacollection.samples'], null=False))
        ))
        db.create_unique('datacollection_datasets_conts', ['datasets_id', 'samples_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field treats on 'Datasets'
        db.delete_table('datacollection_datasets_treats')

        # Removing M2M table for field conts on 'Datasets'
        db.delete_table('datacollection_datasets_conts')
    ...
    models = {
        ...
        'datacollection.datasets': {
            ...
            'conts': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'controls'", 'symmetrical': 'False', 'to': "orm['datacollection.Samples']"}),
            ...
            'treats': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'treatments'", 'symmetrical': 'False', 'to': "orm['datacollection.Samples']"}),
