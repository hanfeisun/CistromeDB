...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conditions.status'
        db.add_column(u'datacollection_conditions', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DiseaseStates.status'
        db.add_column(u'datacollection_diseasestates', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Antibodies.status'
        db.add_column(u'datacollection_antibodies', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Platforms.status'
        db.add_column(u'datacollection_platforms', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conditions.status'
        db.delete_column(u'datacollection_conditions', 'status')

        # Deleting field 'DiseaseStates.status'
        db.delete_column(u'datacollection_diseasestates', 'status')

        # Deleting field 'Antibodies.status'
        db.delete_column(u'datacollection_antibodies', 'status')

        # Deleting field 'Platforms.status'
        db.delete_column(u'datacollection_platforms', 'status')
