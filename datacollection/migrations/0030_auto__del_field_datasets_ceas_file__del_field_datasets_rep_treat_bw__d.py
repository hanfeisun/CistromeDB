...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Datasets.ceas_file'
        db.delete_column(u'datacollection_datasets', 'ceas_file')

        # Deleting field 'Datasets.rep_treat_bw'
        db.delete_column(u'datacollection_datasets', 'rep_treat_bw')

        # Deleting field 'Datasets.seqpos_file'
        db.delete_column(u'datacollection_datasets', 'seqpos_file')

        # Deleting field 'Datasets.treat_bw_file'
        db.delete_column(u'datacollection_datasets', 'treat_bw_file')

        # Deleting field 'Datasets.cont_bw_file'
        db.delete_column(u'datacollection_datasets', 'cont_bw_file')

        # Deleting field 'Datasets.rep_treat_summits'
        db.delete_column(u'datacollection_datasets', 'rep_treat_summits')

        # Deleting field 'Datasets.conf_file'
        db.delete_column(u'datacollection_datasets', 'conf_file')

        # Deleting field 'Datasets.conservation_r_file'
        db.delete_column(u'datacollection_datasets', 'conservation_r_file')

        # Deleting field 'Datasets.summit_file'
        db.delete_column(u'datacollection_datasets', 'summit_file')

        # Deleting field 'Datasets.cor_pdf_file'
        db.delete_column(u'datacollection_datasets', 'cor_pdf_file')

        # Deleting field 'Datasets.rep_treat_peaks'
        db.delete_column(u'datacollection_datasets', 'rep_treat_peaks')

        # Deleting field 'Datasets.rep_cont_bw'
        db.delete_column(u'datacollection_datasets', 'rep_cont_bw')

        # Deleting field 'Datasets.dhs_file'
        db.delete_column(u'datacollection_datasets', 'dhs_file')

        # Deleting field 'Datasets.peak_xls_file'
        db.delete_column(u'datacollection_datasets', 'peak_xls_file')

        # Deleting field 'Datasets.peak_file'
        db.delete_column(u'datacollection_datasets', 'peak_file')

        # Deleting field 'Datasets.conservation_file'
        db.delete_column(u'datacollection_datasets', 'conservation_file')

        # Deleting field 'Datasets.venn_file'
        db.delete_column(u'datacollection_datasets', 'venn_file')

        # Deleting field 'Datasets.ceas_r_file'
        db.delete_column(u'datacollection_datasets', 'ceas_r_file')

        # Deleting field 'Datasets.cor_r_file'
        db.delete_column(u'datacollection_datasets', 'cor_r_file')

        # Deleting field 'Datasets.log_file'
        db.delete_column(u'datacollection_datasets', 'log_file')

        # Deleting field 'Datasets.summary_file'
        db.delete_column(u'datacollection_datasets', 'summary_file')

        # Deleting field 'Datasets.ceas_xls_file'
        db.delete_column(u'datacollection_datasets', 'ceas_xls_file')

        # Adding field 'Datasets.result_folder'
        db.add_column(u'datacollection_datasets', 'result_folder',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Datasets.ceas_file'
        db.add_column(u'datacollection_datasets', 'ceas_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.rep_treat_bw'
        db.add_column(u'datacollection_datasets', 'rep_treat_bw',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.seqpos_file'
        db.add_column(u'datacollection_datasets', 'seqpos_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.treat_bw_file'
        db.add_column(u'datacollection_datasets', 'treat_bw_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.cont_bw_file'
        db.add_column(u'datacollection_datasets', 'cont_bw_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.rep_treat_summits'
        db.add_column(u'datacollection_datasets', 'rep_treat_summits',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.conf_file'
        db.add_column(u'datacollection_datasets', 'conf_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.conservation_r_file'
        db.add_column(u'datacollection_datasets', 'conservation_r_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.summit_file'
        db.add_column(u'datacollection_datasets', 'summit_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.cor_pdf_file'
        db.add_column(u'datacollection_datasets', 'cor_pdf_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.rep_treat_peaks'
        db.add_column(u'datacollection_datasets', 'rep_treat_peaks',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.rep_cont_bw'
        db.add_column(u'datacollection_datasets', 'rep_cont_bw',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.dhs_file'
        db.add_column(u'datacollection_datasets', 'dhs_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.peak_xls_file'
        db.add_column(u'datacollection_datasets', 'peak_xls_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.peak_file'
        db.add_column(u'datacollection_datasets', 'peak_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.conservation_file'
        db.add_column(u'datacollection_datasets', 'conservation_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.venn_file'
        db.add_column(u'datacollection_datasets', 'venn_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.ceas_r_file'
        db.add_column(u'datacollection_datasets', 'ceas_r_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.cor_r_file'
        db.add_column(u'datacollection_datasets', 'cor_r_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.log_file'
        db.add_column(u'datacollection_datasets', 'log_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.summary_file'
        db.add_column(u'datacollection_datasets', 'summary_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Datasets.ceas_xls_file'
        db.add_column(u'datacollection_datasets', 'ceas_xls_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Datasets.result_folder'
        db.delete_column(u'datacollection_datasets', 'result_folder')
