...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Samples.strain'
        db.alter_column(u'datacollection_samples', 'strain_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Strains'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Samples.cell_type'
        db.alter_column(u'datacollection_samples', 'cell_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.CellTypes'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Samples.disease_state'
        db.alter_column(u'datacollection_samples', 'disease_state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.DiseaseStates'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Samples.species'
        db.alter_column(u'datacollection_samples', 'species_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Species'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Samples.platform'
        db.alter_column(u'datacollection_samples', 'platform_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Platforms'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Samples.cell_pop'
        db.alter_column(u'datacollection_samples', 'cell_pop_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.CellPops'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Samples.factor'
        db.alter_column(u'datacollection_samples', 'factor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Factors'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Samples.assembly'
        db.alter_column(u'datacollection_samples', 'assembly_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Assemblies'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Samples.tissue_type'
        db.alter_column(u'datacollection_samples', 'tissue_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.TissueTypes'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Samples.condition'
        db.alter_column(u'datacollection_samples', 'condition_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Conditions'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Samples.curator'
        db.alter_column(u'datacollection_samples', 'curator_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['auth.User'], null=True))

        # Changing field 'Samples.antibody'
        db.alter_column(u'datacollection_samples', 'antibody_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['datacollection.Antibodies'], null=True))

    def backwards(self, orm):

        # Changing field 'Samples.strain'
        db.alter_column(u'datacollection_samples', 'strain_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Strains'], null=True))

        # Changing field 'Samples.cell_type'
        db.alter_column(u'datacollection_samples', 'cell_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.CellTypes'], null=True))

        # Changing field 'Samples.disease_state'
        db.alter_column(u'datacollection_samples', 'disease_state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.DiseaseStates'], null=True))

        # Changing field 'Samples.species'
        db.alter_column(u'datacollection_samples', 'species_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Species'], null=True))

        # Changing field 'Samples.platform'
        db.alter_column(u'datacollection_samples', 'platform_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Platforms'], null=True))

        # Changing field 'Samples.cell_pop'
        db.alter_column(u'datacollection_samples', 'cell_pop_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.CellPops'], null=True))

        # Changing field 'Samples.factor'
        db.alter_column(u'datacollection_samples', 'factor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Factors'], null=True))

        # Changing field 'Samples.assembly'
        db.alter_column(u'datacollection_samples', 'assembly_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Assemblies'], null=True))

        # Changing field 'Samples.tissue_type'
        db.alter_column(u'datacollection_samples', 'tissue_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.TissueTypes'], null=True))

        # Changing field 'Samples.condition'
        db.alter_column(u'datacollection_samples', 'condition_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Conditions'], null=True))

        # Changing field 'Samples.curator'
        db.alter_column(u'datacollection_samples', 'curator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Samples.antibody'
        db.alter_column(u'datacollection_samples', 'antibody_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['datacollection.Antibodies']))
    ...
    models = {
        ...
        u'datacollection.samples': {
            ...
            'cell_line': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['datacollection.CellLines']", 'null': 'True', 'blank': 'True'}),
