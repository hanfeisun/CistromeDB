...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Datasets.qc'
        db.alter_column(u'datacollection_datasets', 'qc_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['datacollection.Qc'], unique=True, null=True))
        # Adding unique constraint on 'Datasets', fields ['qc']
        db.create_unique(u'datacollection_datasets', ['qc_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Datasets', fields ['qc']
        db.delete_unique(u'datacollection_datasets', ['qc_id'])


        # Changing field 'Datasets.qc'
        db.alter_column(u'datacollection_datasets', 'qc_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Qc'], null=True))
    ...
    models = {
        ...
        u'datacollection.datasets': {
            ...
            'qc': ('django.db.models.fields.related.OneToOneField', [], {'default': 'None', 'to': u"orm['datacollection.Qc']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
