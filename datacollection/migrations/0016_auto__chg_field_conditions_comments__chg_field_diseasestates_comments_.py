...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'datacollection_conditions', 'comments', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DiseaseStates.comments'
        db.alter_column(u'datacollection_diseasestates', 'comments', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'CellPops.comments'
        db.alter_column(u'datacollection_cellpops', 'comments', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Strains.comments'
        db.alter_column(u'datacollection_strains', 'comments', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Antibodies.comments'
        db.alter_column(u'datacollection_antibodies', 'comments', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'CellTypes.comments'
        db.alter_column(u'datacollection_celltypes', 'comments', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'TissueTypes.comments'
        db.alter_column(u'datacollection_tissuetypes', 'comments', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'CellLines.comments'
        db.alter_column(u'datacollection_celllines', 'comments', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Adding field 'Samples.update_date'
        db.add_column(u'datacollection_samples', 'update_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Factors.comments'
        db.alter_column(u'datacollection_factors', 'comments', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Conditions.comments'
        db.alter_column(u'datacollection_conditions', 'comments', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'DiseaseStates.comments'
        db.alter_column(u'datacollection_diseasestates', 'comments', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CellPops.comments'
        db.alter_column(u'datacollection_cellpops', 'comments', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Strains.comments'
        db.alter_column(u'datacollection_strains', 'comments', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Antibodies.comments'
        db.alter_column(u'datacollection_antibodies', 'comments', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CellTypes.comments'
        db.alter_column(u'datacollection_celltypes', 'comments', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'TissueTypes.comments'
        db.alter_column(u'datacollection_tissuetypes', 'comments', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CellLines.comments'
        db.alter_column(u'datacollection_celllines', 'comments', self.gf('django.db.models.fields.TextField')(null=True))
        # Deleting field 'Samples.update_date'
        db.delete_column(u'datacollection_samples', 'update_date')


        # Changing field 'Factors.comments'
        db.alter_column(u'datacollection_factors', 'comments', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'datacollection.samples': {
            ...
            'unique_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'update_date': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
