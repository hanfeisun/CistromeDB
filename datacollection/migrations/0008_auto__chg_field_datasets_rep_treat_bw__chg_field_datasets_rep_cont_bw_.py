...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Datasets.rep_treat_bw'
        db.alter_column('datacollection_datasets', 'rep_treat_bw', self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True))

        # Changing field 'Datasets.rep_cont_bw'
        db.alter_column('datacollection_datasets', 'rep_cont_bw', self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True))

        # Changing field 'Datasets.rep_treat_peaks'
        db.alter_column('datacollection_datasets', 'rep_treat_peaks', self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True))

        # Changing field 'Datasets.rep_treat_summits'
        db.alter_column('datacollection_datasets', 'rep_treat_summits', self.gf('django.db.models.fields.files.FileField')(max_length=1024, null=True))


    def backwards(self, orm):
        
        # Changing field 'Datasets.rep_treat_bw'
        db.alter_column('datacollection_datasets', 'rep_treat_bw', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Datasets.rep_cont_bw'
        db.alter_column('datacollection_datasets', 'rep_cont_bw', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Datasets.rep_treat_peaks'
        db.alter_column('datacollection_datasets', 'rep_treat_peaks', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Datasets.rep_treat_summits'
        db.alter_column('datacollection_datasets', 'rep_treat_summits', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))
