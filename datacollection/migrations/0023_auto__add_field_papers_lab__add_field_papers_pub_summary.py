...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Papers.lab'
        db.add_column(u'datacollection_papers', 'lab',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Papers.pub_summary'
        db.add_column(u'datacollection_papers', 'pub_summary',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Papers.lab'
        db.delete_column(u'datacollection_papers', 'lab')

        # Deleting field 'Papers.pub_summary'
        db.delete_column(u'datacollection_papers', 'pub_summary')
