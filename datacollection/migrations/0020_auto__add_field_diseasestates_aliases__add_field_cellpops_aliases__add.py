...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DiseaseStates.aliases'
        db.add_column(u'datacollection_diseasestates', 'aliases',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CellPops.aliases'
        db.add_column(u'datacollection_cellpops', 'aliases',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Strains.aliases'
        db.add_column(u'datacollection_strains', 'aliases',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CellTypes.aliases'
        db.add_column(u'datacollection_celltypes', 'aliases',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TissueTypes.aliases'
        db.add_column(u'datacollection_tissuetypes', 'aliases',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Datasets.paper'
        db.alter_column(u'datacollection_datasets', 'paper_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Papers'], null=True, on_delete=models.SET_NULL))
        # Adding field 'CellLines.aliases'
        db.add_column(u'datacollection_celllines', 'aliases',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Samples.paper'
        db.alter_column(u'datacollection_samples', 'paper_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Papers'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting field 'DiseaseStates.aliases'
        db.delete_column(u'datacollection_diseasestates', 'aliases')

        # Deleting field 'CellPops.aliases'
        db.delete_column(u'datacollection_cellpops', 'aliases')

        # Deleting field 'Strains.aliases'
        db.delete_column(u'datacollection_strains', 'aliases')

        # Deleting field 'CellTypes.aliases'
        db.delete_column(u'datacollection_celltypes', 'aliases')

        # Deleting field 'TissueTypes.aliases'
        db.delete_column(u'datacollection_tissuetypes', 'aliases')


        # Changing field 'Datasets.paper'
        db.alter_column(u'datacollection_datasets', 'paper_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Papers'], null=True))
        # Deleting field 'CellLines.aliases'
        db.delete_column(u'datacollection_celllines', 'aliases')


        # Changing field 'Samples.paper'
        db.alter_column(u'datacollection_samples', 'paper_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datacollection.Papers'], null=True))
    ...
    models = {
        ...
        u'datacollection.celllines': {
            ...
            'aliases': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'comments': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "u'new'", 'max_length': '255', 'null': 'True', 'blank': 'True'})
